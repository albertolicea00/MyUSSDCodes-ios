...
**This is NOT a monorepo.** The catalog data lives in [MyUSSDCodes-collection](https://github.com/albertolicea00/MyUSSDCodes-collection) and the Android app in [MyUSSDCodes-apk](https://github.com/albertolicea00/MyUSSDCodes-apk) — separate repositories. Never add USSD code data here beyond the bundled seed resource.
